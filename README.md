...
[![MCP Tools](https://img.shields.io/badge/MCP%20tools-37-orange)](documentation/tools.md)
...
| [Tools](documentation/tools.md) | All 37 MCP tools, the parallel REST attachment API, search signals, progressive summarization |
