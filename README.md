...
[![MCP Tools](https://img.shields.io/badge/MCP%20tools-45-orange)](documentation/tools.md)
...
| [Tools](documentation/tools.md) | All 45 MCP tools, the parallel REST attachment API, search signals, progressive summarization |
